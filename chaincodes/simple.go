...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	return shim.Error("ERROR_WRONG_FORMAT at Invoke")
}
...
func (t *SimpleChaincode) Open(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 2 {
		return shim.Error("ERROR_WRONG_FORMAT: Enter 2 args")
	}
	...
	if err != nil {
		return shim.Error("ERROR_WRONG_FORMAT: need a number arg[1]")
	}
...
func (t *SimpleChaincode) Delete(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 1 {
		return shim.Error("ERROR_WRONG_FORMAT: Enter 1 argument")
	}
...
func (t *SimpleChaincode) Query(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 1 {
		return shim.Error("ERROR_WRONG_FORMAT: Enter 1 arg")
	}
...
func (t *SimpleChaincode) Transfer(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 3 {
		return shim.Error("ERROR_WRONG_FORMAT: Enter 3 arg")
	}
	money, err := strconv.Atoi(args[2])
	if err != nil {
		return shim.Error("ERROR_WRONG_FORMAT: Numneric value for arg[2]")
	}
